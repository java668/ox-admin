...
import com.java668.common.properties.GeneratorProperties;
import com.java668.common.utils.SpringUtils;
...
public class GenUtils {
    ...
    public static void initTable(Table table) {
        GeneratorProperties config = SpringUtils.getBean(GeneratorProperties.class);
        table.setClassName(convertClassName(table.getTableName()));
        table.setPackageName(config.getPackageName());
        table.setModuleName(getModuleName(config.getPackageName()));
    ...
    public static String convertClassName(String tableName) {
        GeneratorProperties config = SpringUtils.getBean(GeneratorProperties.class);
        boolean autoRemovePre = config.getAutoRemovePre();
